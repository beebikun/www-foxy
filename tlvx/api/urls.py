...
urlpatterns = patterns('',
	#незабудь закоментить верхнюю строчку
	url(r'^$', root.ApiRoot.as_view()),	
	url(r'^buildings/search/?$', root.BuildingSearch.as_view(), name='building-search'),
	url(r'^street/?$', root.StreetRoot.as_view(), name='street'),
	url(r'^markers-icons/?$', root.MarkerIconsRoot.as_view(), name='markers-icons'),
